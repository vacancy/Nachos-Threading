...
public class OpenFile {
     ...
     * @param name
     *            the name of the file, on that file system.
     */
     ...
     * @param offset
     *            the offset in the buffer to start storing bytes.
     * @param length
     ...
     *
     * @param pos
     *            the offset in the file at which to start writing.
     * @param buf
     *            the buffer to get the bytes from.
     * @param offset
     *            the offset in the buffer to start getting.
     * @param length
