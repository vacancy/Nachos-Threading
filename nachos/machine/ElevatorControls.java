...
public interface ElevatorControls {
     ...
     *
     * @param handler
     *            the elevator interrupt handler.
     */
     ...
     *
     * @param elevator
     *            which elevator's doors to open.
     */
     ...
     *
     * @param elevator
     *            which elevator's doors to close.
     */
     ...
     *
     * @param elevator
     *            the elevator whose direction display to set.
     * @param direction
     *            the direction to show (up, down, or neither).
     */
