...
public final class ElevatorTest {
    ...
    private class ElevatorController implements ElevatorControllerInterface {
        ...
        public void run() {
            ...
            e = getNextEvent();
            Lib.assertTrue(e.event == ElevatorEvent.eventUpButtonPressed && e.floor == 0);

            controls.setDirectionDisplay(0, dirUp);
            controls.openDoors(0);

            e = getNextEvent();
            Lib.assertTrue(e.event == ElevatorEvent.eventFloorButtonPressed && e.floor == 1);

            controls.closeDoors(0);
            controls.moveTo(1, 0);

            e = getNextEvent();
            Lib.assertTrue(e.event == ElevatorEvent.eventElevatorArrived && e.floor == 1 && e.elevator == 0);
    ...
    private class Rider implements RiderInterface {
        ...
        public void run() {
            ...
            e = getNextEvent();
            Lib.assertTrue(e.event == RiderEvent.eventDoorsOpened && e.floor == 0 && e.elevator == 0);
            ...
            e = getNextEvent();
            Lib.assertTrue(e.event == RiderEvent.eventDoorsClosed && e.floor == 0 && e.elevator == 0);

            e = getNextEvent();
            Lib.assertTrue(e.event == RiderEvent.eventDoorsOpened && e.floor == 1 && e.elevator == 0);
